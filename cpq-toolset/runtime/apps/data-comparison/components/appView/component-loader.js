...
class DataComparisonAppView {
    ...
    async init() {
        console.log('Data Comparison Component Loader initializing...');
        
        this.setupShellCommunication();
        this.bindEvents();
        // Icons are now using SLDS SVG icons
    ...
    // Removed Lucide icons - using SLDS SVG icons
    ...
    requestThemeData() {
        ...
        setTimeout(() => {
            if (!this.themeReceived) {
                console.warn('No theme received, using dark theme by default');
