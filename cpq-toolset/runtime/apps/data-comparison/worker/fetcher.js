const { getInstance: getPathResolver } = require(getPathResolver().getSharedModule('utils/pathResolver'));
// CPQ Toolset v3 - Individual Fetcher Worker Process
const path = require('path')
const { getInstance: getPathResolver } = require(getPathResolver().getSharedModule('utils/pathResolver'))
const { getInstance: getGraphQLRunner } = require(getPathResolver().getSharedModule('utils/graphqlRunner'))
