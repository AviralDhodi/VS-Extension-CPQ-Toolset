...
class FilterConfiguration {
    ...
    async loadConfiguration() {
        this.logger.info('[Processing] Loading filter configuration from URL params');
    ...
    async loadExistingFilters() {
        this.logger.info('[List] Loading existing filter configurations');
    ...
    async loadObjectFields(objectName) {
        this.logger.info('[Detecting] Loading fields for filter configuration', { object: objectName });
    ...
    async previewFilter() {
        this.logger.info('[Preview] Generating filter preview');
    ...
    async saveFilters() {
        this.logger.info('[Saving] Saving filter configuration');
    ...
    async finishConfiguration() {
        this.logger.info('[Success] Finishing configuration setup');
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('[Starting] DOM loaded, initializing Filter Configuration...');
