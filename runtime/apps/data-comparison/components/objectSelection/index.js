...
class ObjectSelection {
    ...
    async init() {
        console.log(`[Starting] ${this.appName} initializing...`);
        console.log(`[Network] In extension shell: ${this.isInExtensionShell}`);
    ...
    async loadConfiguration() {
        this.logger.info('[Processing] Loading configuration from URL params');
    ...
    async loadCommonObjects() {
        this.logger.info('[Detecting] Loading common objects across selected orgs');
    ...
    async handleObjectClick(objectName) {
        this.logger.info('[List] Object selected', { object: objectName });
    ...
    async loadObjectFields(objectName) {
        this.logger.info('[Detecting] Loading fields for object', { object: objectName });
    ...
    async validateAndSave() {
        this.logger.info('[Detecting] Starting validation and save process');
    ...
    async saveValidatedConfig() {
        this.logger.info('[Saving] Saving validated configuration to file');
    ...
    showValidationSuccess(results) {
        this.logger.info('[Success] All validations passed');
    ...
    navigateToConfigGenerator() {
        this.logger.info('[Back] Navigating back to configuration generator');
    ...
    navigateToFilters() {
        this.logger.info('[Forward] Navigating to filter configuration');
    ...
    async saveAnyway() {
        this.logger.warn('[Warning] Saving configuration despite validation warnings');
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('[Starting] DOM loaded, initializing Object Selection...');
